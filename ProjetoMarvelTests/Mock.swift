...
//  ProjetoMarvelTests
//
//  Created by c94289a on 06/12/21.
//
...
class MockMainView: MainViewProtocol {
    ...
    func showUserAlert(message: String) {
        count += 1
        print("Passei aqui \(countShowAlert)")
    }
...
class MockUrl: UrlApiProtocol {
    var baseURL: String = ""
    var publicKey: String = ""
    var privateKey: String = ""
    var ts: Int = 0
    
    func setUrl() -> String { return "" }
    
    func setUrlInfiniteScroll(offset: Int, limit: Int) -> String { return "" }
    
    func setUrlSearchName(nameStartsWith: String, offset: Int, limit: Int) -> String { return "" }
    
}

class MockAPI: MarvelAPIProtocol {
...
class MockArrayWhenSearchHeroFromApi: MarvelAPIProtocol {
    var getURL: UrlApiProtocol
    init (url: UrlApiProtocol) {
        self.getURL = url
    }
    ...
    func getDados(url: String, completion: @escaping (Result<Hero?, ApiError>) -> Void) {
        apiRequest = true
        guard let data = searchJson.data(using: .utf8) else { return }
        let decoder: JSONDecoder = JSONDecoder()
        let decodeData = try! decoder.decode(Hero.self, from: data)
        completion(Result.success(decodeData))
    }
...
class MockArrayWhenSearchHeroFromApiReturningEmpty: MarvelAPIProtocol {
    var getURL: UrlApiProtocol
    init (url: UrlApiProtocol) {
        self.getURL = url
    }
    ...
    func getDados(url: String, completion: @escaping (Result<Hero?, ApiError>) -> Void) {
        apiRequest = true
        completion(Result.success(Hero(data: nil)))
    }
}

class MockApiReturnigFailureNoInternetError: MarvelAPIProtocol {
    var getURL: UrlApiProtocol
    init (url: UrlApiProtocol) {
        self.getURL = url
    }
...
class MockApiReturnigFailureEmptyDataError: MarvelAPIProtocol {
    var getURL: UrlApiProtocol
    init (url: UrlApiProtocol) {
        self.getURL = url
    }
...
class MockApiReturnigFailureInvalidDataError: MarvelAPIProtocol {
    var getURL: UrlApiProtocol
    init (url: UrlApiProtocol) {
        self.getURL = url
    }
...
class MockApiInfinitScroll: MarvelAPIProtocol {
    var getURL: UrlApiProtocol
    init(url: UrlApiProtocol) {
        self.getURL = url
    }
...
class MockDataBase: DataBaseProtocol {
    ...
    static func checkSavedData(name: String) -> Bool {return false}
...
//
//        var arrayFakeHeroes: [HeroEntity] = []
//        arrayFakeHeroes.append(hero)
//
//        return arrayFakeHeroes
    }
    
    static func removeAllSavedData() {}
}

// esse json tem dois herois
let searchJson = """
    {
      "data": {
        "offset": 0,
        ...
        "results": [
          {
            ...
            "urls": [
              {
                "type": "detail",
                "url": "http://marvel.com/comics/characters/1009149/abyss?utm_campaign=apiRef&utm_source=6a3b3501f02daf45fa9354a8056ec062"
              },
              {
                "type": "wiki",
                "url": "http://marvel.com/universe/Abyss_(alien)?utm_campaign=apiRef&utm_source=6a3b3501f02daf45fa9354a8056ec062"
              },
              {
                "type": "comiclink",
                "url": "http://marvel.com/comics/characters/1009149/abyss?utm_campaign=apiRef&utm_source=6a3b3501f02daf45fa9354a8056ec062"
          ...
          },
          {
            ...
            "urls": [
              {
                "type": "detail",
                "url": "http://marvel.com/characters/85/abyss?utm_campaign=apiRef&utm_source=6a3b3501f02daf45fa9354a8056ec062"
              },
              {
                "type": "wiki",
                "url": "http://marvel.com/universe/Abyss_(Age_of_Apocalypse)?utm_campaign=apiRef&utm_source=6a3b3501f02daf45fa9354a8056ec062"
              },
              {
                "type": "comiclink",
                "url": "http://marvel.com/comics/characters/1010903/abyss_age_of_apocalypse?utm_campaign=apiRef&utm_source=6a3b3501f02daf45fa9354a8056ec062"
              }
            ]
          }
        ]
    ...
    "data": {
        ...
        "results": [{
                ...
                "urls": [
                    {
                        "type": "detail",
                        "url": "http://marvel.com/comics/characters/1011334/3-d_man?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    },
                    {
                        "type": "wiki",
                        "url": "http://marvel.com/universe/3-D_Man_(Chandler)?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    },
                    {
                        "type": "comiclink",
                        "url": "http://marvel.com/comics/characters/1011334/3-d_man?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
            ...
            },
            {
                ...
                "urls": [
                    {
                        "type": "detail",
                        "url": "http://marvel.com/characters/76/a-bomb?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    },
                    {
                        "type": "comiclink",
                        "url": "http://marvel.com/comics/characters/1017100/a-bomb_has?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    }
                ]
            },
            {
                ...
                "urls": [
                    {
                        "type": "detail",
                        "url": "http://marvel.com/characters/77/aim.?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    },
                    {
                        "type": "wiki",
                        "url": "http://marvel.com/universe/A.I.M.?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    },
                    {
                        "type": "comiclink",
                        "url": "http://marvel.com/comics/characters/1009144/aim.?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    }
                ]
            },
            {
                ...
                "urls": [
                    {
                        "type": "detail",
                        "url": "http://marvel.com/characters/2809/aaron_stack?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    },
                    {
                        "type": "comiclink",
                        "url": "http://marvel.com/comics/characters/1010699/aaron_stack?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    }
                ]
            },
            {
                ...
                "urls": [
                    {
                        "type": "detail",
                        "url": "http://marvel.com/characters/81/abomination?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    },
                    {
                        "type": "wiki",
                        "url": "http://marvel.com/universe/Abomination?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    },
                    {
                        "type": "comiclink",
                        "url": "http://marvel.com/comics/characters/1009146/abomination_emil_blonsky?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    }
                ]
            },
            {
                ...
                "urls": [
                    ...
                    {
                        "type": "comiclink",
                        "url": "http://marvel.com/comics/characters/1016823/abomination_ultimate?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    }
                ]
            },
            {
                ...
                "urls": [
                    {
                        "type": "detail",
                        "url": "http://marvel.com/characters/84/absorbing_man?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    },
                    {
                        "type": "wiki",
                        "url": "http://marvel.com/universe/Absorbing_Man?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    },
                    {
                        "type": "comiclink",
                        "url": "http://marvel.com/comics/characters/1009148/absorbing_man?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    }
                ]
            },
            {
                ...
                "urls": [
                    {
                        "type": "detail",
                        "url": "http://marvel.com/characters/2902/adam_destine?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    },
                    {
                        "type": "wiki",
                        "url": "http://marvel.com/universe/Destine,_Adam?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    },
                    {
                        "type": "comiclink",
                        "url": "http://marvel.com/comics/characters/1011266/adam_destine?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    }
                ]
            },
            {
                ...
                "urls": [
                    {
                        "type": "detail",
                        "url": "http://marvel.com/comics/characters/1010354/adam_warlock?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    },
                    {
                        "type": "wiki",
                        "url": "http://marvel.com/universe/Warlock,_Adam?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
                    },
                    {
                        "type": "comiclink",
                        "url": "http://marvel.com/comics/characters/1010354/adam_warlock?utm_campaign=apiRef&utm_source=0b893fc31bff32fa917a5452625b7c9b"
...
//class MockTestReturningError: MarvelAPIProtocol {
//    var getURL: UrlApiProtocol
//    init(url: UrlApiProtocol) {
//        self.getURL = url
//    }
...
//class MockTestReturningOneHero: MarvelAPIProtocol {
//    var getURL: UrlApiProtocol
//    init(url: UrlApiProtocol) {
//        self.getURL = url
//    }
...
//    var offset: Int = 0
//
//    var fakeHero = Hero(data: DataHero(offset: 0, limit: nil, total: nil, count: nil, results: [Results(id: 0, name: "Fake-Hero", description: "description", thumbnail: Image(path: "image", imageExtension: ".jpg"), comics: nil, series: nil, urls: nil)]))
//
//    func getDados(url: String, completion: @escaping (Result<Hero?, ApiError>) -> Void) {
//        completion(.success(fakeHero))
//    }
//}
